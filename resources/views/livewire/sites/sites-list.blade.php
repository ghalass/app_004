<div>
    <livewire:sites.sites-count :count="$count" />
    @foreach ($sites as $site)
        <div wire:key
            class="flex justify-between gap-1 rounded-full py-1 px-2 hover:border-b-2 hover:border-b-blue-200 hover:cursor-pointer hover:bg-slate-50 transition-all">

            <p>{{ $site->name }}</p>

            <div class="flex">
                <button data-modal-target="edit-modal" data-modal-toggle="edit-modal" class="bg-transparent">
                ...
                <button wire:click='show({{ $site }})' data-modal-target="show-modal"
    ...
    <div wire:ignore.self id="edit-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                {{-- <form wire:submit.prevent='editSite' class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea wire:model='form.description' id="edit_description" rows="4"
                    ...
                    <button type="submit"
                        ...
                        <div wire:loading.remove wire:target='editSite' class="flex">
